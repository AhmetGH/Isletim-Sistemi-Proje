...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
       ...
       ArrayList<Process> zamanAsimi = new ArrayList<Process>();
       ...
       for(int saniye=0;saniye<1000;saniye++){
           ...
           for(Process key:zamanAsimi){
               if (key.flag==1) {
                   if (saniye - key.asimZamani == 20) {
                       System.out.println("process zaman aşımında sn: " + saniye);
