...
public class Kuyruk {
    ...
    public ArrayList<Process> nesneolustur() throws FileNotFoundException {
         ...
         */
        File f = new File("C:\\Users\\liman\\OneDrive\\Masaüstü\\Pc aktar\\Isletim-Sistemi-Proje-FurkanLiman-patch-1\\Isletim-Sistemi-Proje-FurkanLiman-patch-1\\IsletimSistemiProje\\src\\Proje\\giriş.txt");
    ...
    public ArrayList<ArrayList> UserjobQueue(ArrayList<Process> userJobList, Process activeProcess, int saniye) {
        ...
        userJobReturn.add(zamanAsimi);
        userJobReturn.set(0, zamanAsimi);
