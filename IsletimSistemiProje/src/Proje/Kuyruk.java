...
public class Kuyruk {
    ...
    public int donguSayisi() throws FileNotFoundException {
        File f = new File("C:\\Users\\liman\\OneDrive\\Masaüstü\\Pc aktar\\Isletim-Sistemi-Proje-FurkanLiman-patch-1\\Isletim-Sistemi-Proje-FurkanLiman-patch-1\\IsletimSistemiProje\\src\\Proje\\giriş1.txt");
    ...
    public ArrayList<ArrayList> UserjobQueue(ArrayList<Process> userJobList, Process activeProcess, int saniye) {
        ...
        zamanAsimi.add(pio1Evrensel);
        zamanAsimi.add(pio2Evrensel);
        zamanAsimi.add(pio3Evrensel);


        zamanAsimi.set(0,pio1Evrensel);
        zamanAsimi.set(1,pio2Evrensel);
        zamanAsimi.set(2,pio3Evrensel);
        */
